// server/ledgerSigner.dmk.mjs
// REFERENCE ONLY -- the production-standard path. Not imported by default; the
// running demo uses server/ledgerSigner.mjs (test-key Speculos). To use this,
// rename it to server/ledgerSigner.mjs, install the DMK deps, and set a valid
// LEDGER_ORIGIN_TOKEN. See the README "production-standard path" section.
//
